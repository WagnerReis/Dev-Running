    ...
    render() {
        ...
        return (
            <div>
                ...
                {
                    this.state.error === 'equal' && <Segment color='red'>A senha e a confirmação devem ser iguais</Segment>
                }
                {
                    this.state.error === 'length' && <Segment color='red'>A senha deve ter mais de 6 caracteres</Segment>
                }
                {
